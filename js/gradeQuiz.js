...
$(document).ready(function(){
    ...
    $("form").submit(function(event) 
    {
        ...
        $("#question3-feedback").append("The answer is <strong>654</strong>");
        ...
        else
        {
            ...
            $("#question4-feedback").append("The answer is <strong>Peter Plympton Smith <br/>(We meant the founding president of CSUMB)</strong>");
        }
